...
class SingleCoreDR : public IDigitRecognizer
{
	...
	inline float_t GetDisp(const Dataset& dataset, uint32_t offset, uint32_t batch_scale);
	inline void NormalizeResLayer(std::array<float_t, RESULT_NEURONS>& res_layer);
