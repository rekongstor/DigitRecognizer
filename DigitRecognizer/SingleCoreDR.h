...
class SingleCoreDR : public IDigitRecognizer
{
	...
	std::array<float_t[IMG_SIZE * IMG_SIZE], LAYER_1_NEURONS> layer_1_weights;

	// layer 2: 16 neurons
	std::array<float_t, LAYER_2_NEURONS> layer_2_biases;
	std::array<float_t[LAYER_1_NEURONS], LAYER_2_NEURONS> layer_2_weights;

	// resulting layer: 10 neurons
	std::array<float_t, RESULT_NEURONS> res_layer_biases;
	std::array<float_t[LAYER_2_NEURONS], RESULT_NEURONS> res_layer_weights;
